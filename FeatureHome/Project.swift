...
let project = Project(
  ...
  targets: [
    .target(
      ...
      destinations: [.iPhone],
      product: .framework,
      bundleId: "com.seungwan.CoachCoach.FeatureHome",
      ...
      settings: .settings(
        base: [
          "SWIFTUI_PREVIEW_HOST_APPLICATION": "$(BUILT_PRODUCTS_DIR)/FeatureHomeDemo.app/FeatureHomeDemo"
        ]
      )
    ),
    .target(
      ...
      destinations: [.iPhone],
      product: .app,
      bundleId: "com.seungwan.CoachCoach.FeatureHomeDemo",
      deploymentTargets: .iOS("17.0"),
