...
let project = Project(
  ...
  targets: [
    .target(
      ...
      destinations: [.iPhone],
      product: .framework,
      bundleId: "com.seungwan.CoachCoach.FeatureAICoach",
      ...
      settings: .settings(
        base: [
          "SWIFTUI_PREVIEW_HOST_APPLICATION": "$(BUILT_PRODUCTS_DIR)/FeatureAICoachDemo.app/FeatureAICoachDemo"
        ]
      )
    ),
    .target(
      name: "FeatureAICoachDemo",
      destinations: [.iPhone],
      product: .app,
      bundleId: "com.seungwan.CoachCoach.FeatureAICoachDemo",
      deploymentTargets: .iOS("17.0"),
