...
let project = Project(
  ...
  targets: [
    .target(
      ...
      destinations: [.iPhone],
      product: .framework,
      bundleId: "com.seungwan.CoachCoach.FeatureMenu",
      ...
      settings: .settings(
        base: [
          "SWIFTUI_PREVIEW_HOST_APPLICATION": "$(BUILT_PRODUCTS_DIR)/FeatureMenuDemo.app/FeatureMenuDemo"
        ]
      )
    ),
    .target(
      name: "FeatureMenuDemo",
      destinations: [.iPhone],
      product: .app,
      bundleId: "com.seungwan.CoachCoach.FeatureMenuDemo",
      deploymentTargets: .iOS("17.0"),
